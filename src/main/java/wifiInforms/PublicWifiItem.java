...
public class PublicWifiItem {
	...
	public void showItems() {
		System.out.println(this.X_SWIFI_MGR_NO + ", " + this.X_SWIFI_WRDOFC + ", " + this.X_SWIFI_MAIN_NM + ", "
        + this.X_SWIFI_ADRES1 + ", " + this.X_SWIFI_ADRES2 + ", " + this.X_SWIFI_INSTL_FLOOR + ", " + this.X_SWIFI_INSTL_TY + ", " +
		this.X_SWIFI_INSTL_MBY + "," + this.X_SWIFI_SVC_SE + ", " + this.X_SWIFI_CMCWR + ", " + this.X_SWIFI_CNSTC_YEAR
		+ ", " + this.X_SWIFI_INOUT_DOOR + ", " + this.X_SWIFI_REMARS3 + ", " + this.LAT + ", " + this.LNT + "," + this.WORK_DTTM) ;
